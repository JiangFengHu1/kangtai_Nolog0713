...
- (void)layUI
{
    ...
    logoImgView.image = [UIImage imageNamed:@"logo_2.png"];
    
    UIImageView *backImgView = [[UIImageView alloc] initWithFrame:CGRectMake(0, -20, kScreen_Width, kScreen_Height)];
    backImgView.image = [UIImage imageNamed:@"login_back_2.png"];
    ...
    [signUp setTitleColor:[UIColor colorWithRed:31.0/255 green:145.0/255 blue:228.0/255 alpha:1] forState:UIControlStateNormal];
    ...
    [forgetPWDBtn setTitleColor:RGBA(206, 206, 206, 1) forState:UIControlStateNormal];
