...
- (void)loadUI
{
    ...
    for (int i = 0; i < 2; i++) {
        ...
        actionNameLab.adjustsFontSizeToFitWidth = YES;
    ...
    UILabel *repeatLabel = [[UILabel alloc] initWithFrame:CGRectMake(powerLab.frame.origin.x, powerLab.frame.origin.y +powerLab.frame.origin.y - afterLab.frame.origin.y - 22, 58, size.height)];
